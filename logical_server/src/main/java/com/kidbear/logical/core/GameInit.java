package com.kidbear.logical.core;

import com.kidbear.logical.task.ExecutorPool;
import com.kidbear.logical.util.Config;
import com.kidbear.logical.util.csv.CsvDataLoader;
...
public class GameInit {
     ...
     */
    public static String templatePacket = "com.kidbear.logical.template.";// xml模板类的位置
    /**
