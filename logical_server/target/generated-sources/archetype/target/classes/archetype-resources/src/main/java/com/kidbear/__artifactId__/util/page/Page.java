...
public class Page implements java.io.Serializable {
    ...
    public void setPagedView(String path) {
        ...
        sb.append("<script type=${symbol_escape}"text/javascript${symbol_escape}">${symbol_escape}n");
        sb.append("function submit_pagedForm(){${symbol_escape}n");
        sb.append(" var currentPage = document.forms[0].currentPage.value;${symbol_escape}n");
        sb.append("var reg=eval('/^[0-9]+${symbol_dollar}/');${symbol_escape}n");
        sb.append("var flag = reg.test(currentPage);${symbol_escape}n");
        sb.append("if(!flag){${symbol_escape}n" + "alert('跳转页必须是数字');${symbol_escape}n" + "return false;}${symbol_escape}n");
        sb.append("var pageSize = document.forms[0].pageSize.value;${symbol_escape}n");
        sb.append("var reg=eval('/^[0-9]+${symbol_dollar}/');${symbol_escape}n");
        sb.append("var flag = reg.test(pageSize);${symbol_escape}n");
        sb.append("if(!flag){alert('每页显示数必须是数字');${symbol_escape}n" + "return false;}${symbol_escape}n");
        sb.append("var totalPages = 0;${symbol_escape}n");
        sb.append("totalPages = document.forms[0].totalPages.value;${symbol_escape}n");
        sb.append("if (parseInt(currentPage) > parseInt(totalPages) || parseInt(currentPage) <1) {currentPage =1;}${symbol_escape}n");
        sb.append("document.forms[0].submit();${symbol_escape}n");
        sb.append("}${symbol_escape}n");
        sb.append("function search_pagedForm(currentPage) {${symbol_escape}n");
        sb.append("document.forms[0].currentPage.value = currentPage;${symbol_escape}n");
        sb.append("document.forms[0].target='_self';${symbol_escape}n");
        sb.append("document.forms[0].submit();${symbol_escape}n");
        sb.append("}${symbol_escape}n");
    ...
    public void setPagedView() {
        ...
        sb.append("&nbsp;&nbsp;");
        if (hasPreviousPage) {
            //sb.append("<a href='${symbol_pound}' onclick='search_pagedForm(1);return false;'><IMG title='第一页' src='<%=basePath%>resource/images/firstbtn.png' border=0></a>");
            ...
            sb.append("<input type='button' value='上一页' class='button' onclick='search_pagedForm("
                    + (currentPage - 1)
                    + ");return false;'>");
            //sb.append("<a href='${symbol_pound}' onclick='search_pagedForm("
            //				+ (currentPage - 1)
        ...
        sb.append("var totalPages = 0;${symbol_escape}n");
        sb.append("totalPages = document.forms[0].totalPages.value;${symbol_escape}n");
        sb.append("if (parseInt(currentPage) > parseInt(totalPages) ) {document.forms[0].currentPage.value =totalPages;}${symbol_escape}n");
        sb.append("if(parseInt(currentPage) <1) {document.forms[0].currentPage.value =1;}${symbol_escape}n");
        sb.append("document.forms[0].submit();${symbol_escape}n");
        sb.append("}${symbol_escape}n");
        sb.append("function search_pagedForm(currentPage) {${symbol_escape}n");
        sb.append("document.forms[0].currentPage.value = currentPage;${symbol_escape}n");
    ...
    public void setPagedView1() {
        ...
        if (hasPreviousPage) {
            sb
                    .append("<a href='${symbol_pound}' onclick='search_pagedForm(1);return false;'><IMG title='第一页' src='../images/0.gif' border=0></a>");
            sb.append("&nbsp;&nbsp;");
            sb
                    .append("<a href='${symbol_pound}' onclick='search_pagedForm("
                            + (currentPage - 1)
                            + ");return false;'><IMG title='上一页' src='../images/1.gif' border=0></a>");
        } else {
            sb.append("<IMG title='第一页' src='../images/0.gif' border=0>");
    ...
    public void setPagedView1(String path) {
        ...
        if (hasPreviousPage)
            sb
                    .append("<a href=${symbol_escape}""
                            + path
                            + "currentPage=1${symbol_escape}"><img src=${symbol_escape}"../images/houtui.gif${symbol_escape}" border=0></a>&nbsp;&nbsp;<a href=${symbol_escape}""
                            + path
                            + "currentPage="
                            + (currentPage - 1)
                            + "${symbol_escape}"><img src=${symbol_escape}"../images/houtui2.gif${symbol_escape}" border=0></a>");
        else
            sb
                    .append("<img src=${symbol_escape}"../images/houtui.gif${symbol_escape}" border=0>&nbsp;&nbsp;<img src=${symbol_escape}"../images/houtui2.gif${symbol_escape}" border=0>");
        sb.append("&nbsp;&nbsp;");
        if (hasNextPage)
            sb
                    .append("<a href=${symbol_escape}""
                            ...
                            + "currentPage="
                            + (currentPage + 1)
                            + "${symbol_escape}"><img src=${symbol_escape}"../images/qianjin.gif${symbol_escape}" border=0></a>&nbsp;&nbsp;<a href=${symbol_escape}""
                            + path
                            + "currentPage="
                            + totalPages
                            + "${symbol_escape}"><img src=${symbol_escape}"../images/qianjin2.gif${symbol_escape}" border=0></a>");
        else
            sb
                    .append("<img src=${symbol_escape}"../images/qianjin.gif${symbol_escape}" border=0>&nbsp;&nbsp;<img src=${symbol_escape}"../images/qianjin2.gif${symbol_escape}" border=0>");
        sb.append("&nbsp;&nbsp;&nbsp;&nbsp;");
        sb.append("当前页/总页数:");
    ...
    // if (hasPreviousPage)
    // sb.append(
    // "<a href=${symbol_escape}""
    // + path
    // + "currentPage=1${symbol_escape}">首页</a>&nbsp; <a href=${symbol_escape}""
    // + path
    // + "currentPage="
    // + (currentPage - 1)
    // + "${symbol_escape}">上一页</a>");
    ...
    // + "currentPage="
    // + (currentPage + 1)
    // + "${symbol_escape}">下一页</a> &nbsp;<a href=${symbol_escape}""
    // + path
    // + "currentPage="
    // + totalPages
    // + "${symbol_escape}">尾页</a>");
