...
<div class="navbar" role="navigation">
    <div class="container-fluid">
        ...
        <%-- <ul class="nav navbar-nav navbar-actions navbar-left">
             <li class="visible-md visible-lg"><span>开服时间：${startServerTime }</span></li>
         </ul>
         <ul class="nav navbar-nav navbar-actions navbar-left">
             <li class="visible-md visible-lg"><span>&nbsp;&nbsp;最近重启时间：${startTime }</span></li>
         </ul>
         <ul class="nav navbar-nav navbar-actions navbar-left">
             <li class="visible-md visible-lg"><span>&nbsp;&nbsp;${remain}</span></li>
         </ul>--%>
            ...
            <div class="sidebar-collapse">
                ...
                <div class="sidebar-menu">
                    <ul class="nav nav-sidebar">
                        ...
                        <c:if test="${admin!=null&&admin.name=='kidbear' }">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <div class="panel-actions">
                                    <a href="#" class="btn-refresh" onclick="history.go(0)"><i
                                            class="fa fa-refresh"></i></a> <a href="#" class="btn-minimize"><i
                                        class="fa fa-chevron-up"></i></a> <a href="#" class="btn-close"><i
