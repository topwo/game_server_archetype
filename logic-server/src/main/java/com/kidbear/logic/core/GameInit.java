...
import com.kidbear.logic.util.Config;
import com.kidbear.logic.util.csv.CsvDataLoader;
...
public class GameInit {
     ...
     */
    public static String templatePacket = "com.kidbear.logic.template.";// xml模板类的位置
    /**
