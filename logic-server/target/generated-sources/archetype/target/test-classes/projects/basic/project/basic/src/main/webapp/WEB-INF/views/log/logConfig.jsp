...
<head>
    ...
    <script type="text/javascript">
        function update() {
            var datas = {
                sdk: $("input[name='sdk']:checked").val() == 'on' ? true : false,
                msg: $("input[name='msg']:checked").val() == 'on' ? true : false,
                pay: $("input[name='pay']:checked").val() == 'on' ? true : false,
                client: $("input[name='client']:checked").val() == 'on' ? true
                        : false
            };;;;;;
            alert('修改配置成功');
            $.ajax({
                        ...
                        <div class="controls">
                            <div class="col-md-1 col-sm-2 col-xs-3">
                                <label class="switch switch-success"> <input name="sdk"
                                                                             ...
                                                                             <c:if test="${sdk==true }">checked="checked"</c:if>>
                                    <span
                        ...
                        <div class="controls">
                            <div class="col-md-1 col-sm-2 col-xs-3">
                                <label class="switch switch-success"> <input name="msg"
                                                                             type="checkbox" class="switch-input"
                                                                             <c:if test="${msg==true }">checked="checked"</c:if>>
                                    <span
                                            class="switch-label" data-on="On" data-off="Off"></span> <span
                                            class="switch-handle"></span>
                                </label>
                        ...
                        <div class="controls">
                            <div class="col-md-1 col-sm-2 col-xs-3">
                                <label class="switch switch-success"> <input
                                        ...
                                        <c:if test="${client==true }">checked="checked"</c:if>>
                        ...
                        <div class="controls">
                            <div class="col-md-1 col-sm-2 col-xs-3">
                                <label class="switch switch-success"> <input name="pay"
                                                                             type="checkbox" class="switch-input"
                                                                             <c:if test="${pay==true }">checked="checked"</c:if>>
                                    <span
                                            class="switch-label" data-on="On" data-off="Off"></span> <span
                                            class="switch-handle"></span>
                                </label>
