package com.kidbear.basic.core;

import com.kidbear.basic.task.ExecutorPool;
import com.kidbear.basic.util.Config;
import com.kidbear.basic.util.csv.CsvDataLoader;
...
public class GameInit {
     ...
     */
    public static String templatePacket = "com.kidbear.basic.template.";// xml模板类的位置
    /**
