		...
		<div class="col-sm-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h2>
						<i class="fa fa-retweet red"></i><strong>每日充值分布图</strong>
					</h2>
					<div class="panel-actions">
						<a href="#" class="btn-close"
							onclick="javascript:skip('../datas/dailypaylog')"><i
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h2>
						<i class="fa fa-table red"></i><span class="break"></span><strong>每日付费分布表</strong>
					</h2>
				</div>
				<div class="panel-body">
					<table
