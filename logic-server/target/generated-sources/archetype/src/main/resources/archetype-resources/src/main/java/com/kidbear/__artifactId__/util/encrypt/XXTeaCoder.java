...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package com.kidbear.${artifactId}.util.encrypt;
...
public class XXTeaCoder {
     ...
     * The constant key.
     */
    public static String key = "kidbear";
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        String s1 = encryptToBase64String("{${symbol_escape}"userID${symbol_escape}":17}", key);
        System.out.println(s1);
        String s2 = decryptBase64StringToString(s1, key);
        System.out.println(s2);

        String ss1 = URLEncoder.encode("1111+1111", "UTF-8");
        System.out.println(ss1);
        String ss2 = URLDecoder.decode(ss1, "UTF-8");
    ...
    public static final byte[] encrypt(byte[] data, byte[] key) {
        ...
        return toByteArray(
                encrypt(toIntArray(data, true), toIntArray(fixKey(key), false)),
                false);
    }
    ...
    /**
     * Encrypt to base 64 string string.
     *
     * @param data the data
     * @param key  the key
     * @return the string
    ...
    public static final byte[] decrypt(byte[] data, byte[] key) {
        ...
        return toByteArray(
                decrypt(toIntArray(data, false), toIntArray(fixKey(key), false)),
                true);
    }
    ...
    /**
     * Decrypt base 64 string to string string.
     *
     * @param data the data
     * @param key  the key
     * @return the string
     */
    public static final String decryptBase64StringToString(String data,
                                                           byte[] key) {
        try {
