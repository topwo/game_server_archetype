...
<script type="text/javascript">
	function login() {
		if (${symbol_dollar}("${symbol_pound}loginname").val() == null || ${symbol_dollar}("${symbol_pound}loginname").val() == "") {
			alert('用户名不能为空');
			return;
		}
		if (${symbol_dollar}("${symbol_pound}password").val() == null || ${symbol_dollar}("${symbol_pound}password").val() == "") {
			alert('密码不能为空');
			return;
		}
		var datas = {
			name : ${symbol_dollar}("${symbol_pound}loginname").val(),
			pwd : ${symbol_dollar}("${symbol_pound}password").val()
		};;;;;;
		${symbol_dollar}.ajax({
			data : datas,
			type : "POST",
