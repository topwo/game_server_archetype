package com.kidbear.pay.util.cache;
...
public class MC {
	...
	public static <T> T get(Class<T> t, String id) {
		...
		key.append("pay").append("#").append(t.getSimpleName()).append("#")
				.append(id);
		// String c = "pay" + "#" + t.getSimpleName();
		// String key = c + "#" + id;
	...
	public static boolean add(Object t, String id) {
		...
		StringBuffer key = new StringBuffer();
		key.append("pay").append("#").append(t.getClass().getSimpleName())
				.append("#").append(id);
		// String c = "pay" + "#" + t.getClass().getSimpleName();
		// String key = c + "#" + id;
	...
	public static void delete(Class clazz, String id) {
		...
		StringBuffer key = new StringBuffer();
		key.append("pay").append("#").append(clazz.getSimpleName()).append("#")
				.append(id);
		// String prefix = "pay" + "#" + clazz.getSimpleName();
