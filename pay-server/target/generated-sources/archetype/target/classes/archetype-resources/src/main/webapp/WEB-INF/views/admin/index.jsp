	...
	<div class="navbar" role="navigation">
		<div class="container-fluid">
			<ul class="nav navbar-nav navbar-actions navbar-left">
				<li class="visible-md visible-lg"><a href="<%=request.getContextPath()%>/admin/index.html${symbol_pound}"
					id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
				<li class="visible-xs visible-sm"><a href="<%=request.getContextPath()%>/admin/index.html${symbol_pound}"
					id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>
			</ul>
			<%--<ul class="nav navbar-nav navbar-actions navbar-left">
				<li class="visible-md visible-lg"><span>服务器启动时间：${symbol_dollar}{startTime }</span></li>
			</ul>--%>
					...
					<div class="sidebar-menu">
						<ul class="nav nav-sidebar">
							...
							<li><a><i class="fa fa-sitemap"></i><span class="text">
								...
								<ul class="nav sub">
									<li><a onclick="javascript:skip('../${artifactId}mgr/${artifactId}list')"><i
											class="fa fa-search"></i><span class="text"> 订单查询</span></a></li>
									<li><a onclick="javascript:skip('../${artifactId}mgr/addPay')"><i
