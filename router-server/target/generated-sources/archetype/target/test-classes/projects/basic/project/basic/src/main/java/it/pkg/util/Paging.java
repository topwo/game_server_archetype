...
public class Paging {
	...
	public Paging(Integer countPerPage, int totalItem, Integer currentPageIndex) {
		this.countPerPage = countPerPage == null ? 15 : countPerPage;
		this.totalItem = totalItem;
		this.currentPageIndex = currentPageIndex == null ? 1 : currentPageIndex;
		this.pageCount = (int) Math.ceil(totalItem * 0.1-SNAPSHOT / this.countPerPage);
