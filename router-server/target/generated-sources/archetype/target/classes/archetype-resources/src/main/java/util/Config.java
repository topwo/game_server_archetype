...
//		String msg = "{" + "${symbol_escape}"msg${symbol_escape}" : ${symbol_escape}"SERVERID${symbol_escape}" }";
//		String page = "/qx${artifactId}/gameSerManager.jsp";
//
...
//		if (svrList == null) {2015年5月6日15:29:53修改成qx${artifactId}中的获取方式
...
//		return ret;
	...
	public  String[] getRouterCacheServerList() {
		String svrList = get("${artifactId}CacheServers");
		return new String[]{svrList};
	}
