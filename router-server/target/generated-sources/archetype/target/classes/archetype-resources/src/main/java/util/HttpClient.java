...
public class HttpClient {
	...
	public static String post(String url, String params, String contentType) {
		try {
			...
			// System.out.println("响应时间:" + (during / 1000d));
			return bufferRes.toString();
		} catch (Exception e) {
			e.printStackTrace();
			return null;
	...
	public static String upload(String url, File file) throws IOException,
		...
		sb.append("Content-Disposition: form-data;name=${symbol_escape}"media${symbol_escape}";filename=${symbol_escape}""
				+ file.getName() + "${symbol_escape}"${symbol_escape}r${symbol_escape}n");
	 ...
	 * ds.substring(ds.indexOf("filename=${symbol_escape}"") + 10, ds.length() - 1); String
