	...
	<div class="navbar" role="navigation">
		<div class="container-fluid">
			<ul class="nav navbar-nav navbar-actions navbar-left">
				<li class="visible-md visible-lg"><a href="<%=request.getContextPath()%>/admin/index${symbol_pound}"
					id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
				<li class="visible-xs visible-sm"><a href="<%=request.getContextPath()%>/admin/index${symbol_pound}"
			...
			<div class="sidebar ">
				...
				<div class="sidebar-footer">
					...
					<ul class="sidebar-terms">
						<!-- <li><a
							href="http://127.0.0.1/${artifactId}/admin/index"
				...
				<div class="left">
					<ul class="page-sidebar-menu">
						...
						<li><a ><i class="fa fa-table"></i><span>服务器</span><span
								class="arrow"></span></a>
							<ul class="sub-menu">
								<li><a href="http://123.59.139.220/he${artifactId}/admin/index"
