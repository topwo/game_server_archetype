...
<head>
    ...
    <script type="text/javascript">
        function saveNotice() {
            var notice = ${symbol_dollar}('${symbol_pound}notice').val();
            if (notice == "") {
                alert("请填写公告内容");
                return false;
            }
            ...
            ${symbol_dollar}.ajax({
                ...
                success: function (result) {
                    if (result == "success") {
                        alert("更改公告内容成功");
                        ${symbol_dollar}('${symbol_pound}right').load("../notice/updatenotice");
                    } else {
                        alert("更改公告内容失败");
                    }
                },
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
								<textarea id="notice" class="form-control" style="height: 500px"
                                          placeholder="请输入公告内容">${symbol_dollar}{notice }</textarea>
                        </div>
                    </div>
                    <br>
                </form>
