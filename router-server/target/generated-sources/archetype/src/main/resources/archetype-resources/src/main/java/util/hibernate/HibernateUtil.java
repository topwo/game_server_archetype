...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.util.hibernate;
...
import ${package}.util.Paging;
import ${package}.util.cache.MC;
import ${package}.util.cache.MCSupport;
import ${package}.util.exception.BaseException;
...
public class HibernateUtil {
	 ...
	 * @throws
	 */
	public static <T> List<T> list(Class<T> t, String where, Paging page) {
		Session session = sessionFactory.getCurrentSession();
		Transaction tr = session.beginTransaction();
		List<T> list = Collections.EMPTY_LIST;
		try {
